...
// Structure for association between signal_type and cooking_recipe_category.
typedef struct Recipes
{
    int type;
    char cooking_recipe_category[3][30];
} Recipes;
...
//prints on the console the recipe according to the given signal
// integers a and b represent the position of recipes in the global matrix of "Recipes" structures called "Dishes"
